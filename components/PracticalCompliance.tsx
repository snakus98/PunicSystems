...
const SERVICES: ServiceCard[] = [
  {
    ...
    accent: "text-[#6e29f6]",
    iconBackground: "from-[#01f6f7]/15 to-[#6e29f6]/20",
  },
  {
    icon: LockKeyhole,
    title: "GDPR",
...
const PROMISES = [
  {
    ...
    color: "text-[#01f6f7]",
    border: "border-[#01f6f7]",
  },
  {
    icon: FileText,
    text: "No generic documentation.",
    color: "text-[#6e29f6]",
    border: "border-[#6e29f6]",
  },
  {
    icon: Target,
...
const dots =
  "radial-gradient(circle, rgba(1,246,247,0.34) 1.4px, transparent 1.6px)";
...
export default function PracticalCompliance() {
  return (
    <section className="relative overflow-hidden bg-[#f8faff] pb-20 pt-16 sm:pb-24 sm:pt-20 lg:pb-28">
      ...
      <div className="pointer-events-none absolute left-[31%] top-[12.5rem] h-[31rem] w-[52rem] rounded-[50%] border border-[#01f6f7]/35" />
      <div className="pointer-events-none absolute left-[37%] top-[18rem] h-[25rem] w-[44rem] rounded-[50%] border border-[#6e29f6]/35" />
          ...
          {SERVICES.map((service, index) => (
            <article
              ...
              className={`relative flex flex-col items-center rounded-[1.55rem] border bg-white/95 px-7 py-9 text-center shadow-[0_18px_45px_rgba(22,50,90,0.10)] backdrop-blur sm:px-10 ${
                index === 1
                  ? "border-[#6e29f6] lg:min-h-[470px] lg:-translate-y-5 lg:justify-center lg:border-t-[#01f6f7]"
              ...
              <div
                ...
                className={`relative flex items-center gap-5 lg:px-8 ${
                  index < PROMISES.length - 1
                    ? "lg:after:absolute lg:after:right-0 lg:after:top-1/2 lg:after:h-px lg:after:w-10 lg:after:bg-gradient-to-r lg:after:from-[#01f6f7] lg:after:to-[#6e29f6]"
                    : ""
                }`}
              >
                <span
