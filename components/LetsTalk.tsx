        ...
        <div className="grid lg:min-h-[680px] lg:grid-cols-[43%_57%]">
          <div className="relative z-10 flex items-center px-6 py-16 sm:px-10 lg:px-16 lg:py-20 xl:px-[5.6rem]">
            <div className="max-w-[590px]">
              <p className="flex items-center gap-3 text-sm font-extrabold uppercase tracking-[0.22em] text-[#6e29f6] sm:text-base">
                <span className="h-6 w-[3px] rounded-full bg-[#01f6f7]" />
                Let&apos;s Talk
              </p>
              ...
              <div className="mt-7 flex items-center gap-5 sm:mt-8">
                ...
                <span className="hidden h-16 w-16 shrink-0 items-center justify-center rounded-full bg-white text-[#6e29f6] shadow-[0_0_22px_rgba(1,246,247,0.6)] sm:flex">
                  <MessageCircleMore size={35} strokeWidth={1.8} />
                </span>
              </div>

              <div className="mt-8 h-[3px] w-[315px] max-w-[75%] bg-gradient-to-r from-[#01f6f7] to-[#6e29f6]" />
              ...
              <a
                href="#contact"
                className="button-focus group mt-9 inline-flex min-w-[300px] items-center justify-between rounded-lg border-r-4 border-[#01f6f7] bg-[#6e29f6] px-8 py-4 text-base font-bold text-white shadow-[0_14px_28px_rgba(110,41,246,0.18)] transition-transform hover:-translate-y-0.5 sm:text-lg"
              >
                Book a Consultation
                <ArrowRight
                  size={24}
          ...
          <div className="relative min-h-[430px] overflow-hidden lg:min-h-0">
            ...
            <div className="pointer-events-none absolute bottom-7 left-[12%] h-4 w-[95%] -rotate-3 rounded-full bg-[#01f6f7]/55 blur-[8px]" />
            <div className="pointer-events-none absolute bottom-2 left-[31%] h-3 w-[78%] -rotate-6 rounded-full bg-[#6e29f6]/55 blur-[9px]" />
          </div>
        </div>
      </div>
    </section>
