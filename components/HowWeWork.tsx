...
function PhilosophyPoint({ point }: { point: PhilosophyPoint }) {
  return (
    <div className="grid grid-cols-[3.75rem_minmax(0,1fr)] items-start gap-4">
      <span className="flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full border border-[#6e29f6]/20 bg-gradient-to-br from-[#f7f5ff] to-white text-[#6e29f6] shadow-[0_10px_25px_rgba(110,41,246,0.08)]">
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "repeating-radial-gradient(ellipse at center, transparent 0 14px, rgba(110,41,246,0.35) 15px 16px, transparent 17px 29px)",
        }}
      />
      ...
      <div className="mx-auto grid max-w-[1536px] lg:min-h-[565px] lg:grid-cols-[47%_53%]">
        <div className="relative min-h-[390px] sm:min-h-[490px] lg:min-h-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, rgba(110,41,246,0.65) 2px, transparent 2.4px)",
        ...
        <div className="relative flex items-center px-6 pb-14 pt-20 sm:px-10 lg:px-12 lg:py-16 xl:px-16">
          <div className="w-full max-w-[700px]">
            <p className="text-sm font-extrabold uppercase tracking-[0.04em] text-[#6e29f6] sm:text-base">
              Our Philosophy
            </p>
            <span className="mt-4 block h-0.5 w-10 bg-[#6e29f6]" />
            <h2
            ...
            >
              ...
              never become
              <br />
              <span className="text-[#6e29f6]">shelfware.</span>
            </h2>
      ...
      <div className="container-x relative z-20 mt-12 !max-w-[1425px] lg:mt-9">
        <div className="rounded-xl border border-white bg-white/95 px-5 pb-10 pt-7 shadow-[0_16px_50px_rgba(43,43,121,0.08)] sm:px-8 lg:min-h-[370px] lg:px-12 lg:pb-11">
          <div className="text-center">
            <p className="text-base font-extrabold uppercase tracking-[0.02em] text-[#6e29f6] sm:text-lg">
              How We Work
            </p>
            <span className="mx-auto mt-3 block h-0.5 w-10 bg-[#6e29f6]" />
          </div>

          <div className="relative mt-7">
            <div className="pointer-events-none absolute left-[10%] right-[10%] top-[2.65rem] hidden h-px bg-gradient-to-r from-[#6e29f6]/45 via-[#01f6f7]/55 to-[#6e29f6]/45 lg:block" />
                    ...
                    >
                      <span
                        className={`flex h-[4.85rem] w-[4.85rem] items-center justify-center rounded-full ${
                          isPurple
                            ? "bg-gradient-to-br from-[#01f6f7] to-[#6e29f6] text-white"
                            : "bg-[#f5ffff] text-[#01f6f7] ring-1 ring-[#01f6f7]/25"
                        }`}
                      >
